...
train_set = train_datagen.flow_from_directory(r'C:\Users\kjbua\Dropbox\PC\Downloads\ML-Biomed-Midterm-main\ML-Biomed-Midterm-main\Data\train', target_size=(128, 128), batch_size=32, class_mode='binary')

val_datagen = ImageDataGenerator(rescale=1./255)

val_set = val_datagen.flow_from_directory(r'C:\Users\kjbua\Dropbox\PC\Downloads\ML-Biomed-Midterm-main\ML-Biomed-Midterm-main\Data\test', target_size=(128, 128), batch_size=32, class_mode='binary')
